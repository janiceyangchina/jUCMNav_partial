 ...
 * 
 * @author Jean-François Roy, pchen, jiaying
 * 
 */
...
//        boolean rootFeature = (value!=null && element instanceof Feature && value.equalsIgnoreCase("root feature"));
//        System.out.println("If it is root feature ? "+ rootFeature);
//        if (rootFeature)
//        	return false;
    ...
    /**
     * Returns true if the intentionalElement can be deleted.
     * 
     * @see org.eclipse.gef.commands.Command#calculateEnabled()
     */
