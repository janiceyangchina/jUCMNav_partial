...
import seg.jUCMNav.scenarios.model.StrategyEvaluationWarning;
 ...
 * 
 * @author Yanji Liu, Yukun Su, gunterm, jiaying
 * 
 */
...
//                System.out.println("The number of problem list is "+ existingMarkers.length);
                for (int i = 0; i < existingMarkers.length; i++) {
                    IMarker marker = existingMarkers[i];
                    System.out.println("The problem views to be deleted is "+ marker.getAttribute(IMarker.MESSAGE, "None problems are found")); 
                    System.out.println("The problem of location is "+ marker.getAttribute(IMarker.LOCATION, null));
                    System.out.println("The marker of the problem type is "+marker.getType());
                    marker.delete();
                }
                    ...
                    try {
                        ...
                        if (o.getLocation() instanceof URNmodelElement) {
                            ...
                            if (o.getLocation() instanceof IntentionalElementRef){
                            	marker.setAttribute("EObject", ((IntentionalElementRef)o.getLocation()).getId());
                            }else{
